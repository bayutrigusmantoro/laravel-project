          ...
          <table class="table table-bordered table-striped dataTable">
            ...
            <tr>
              <td> {{$makan->nama_makan}}</td>
                <td> {{$makan->kode_makan}}</td>
                    <td> {{$makan->harga_beli}}</td>
                    <td> {{$makan->harga_jual}}</td>
                  <td> {{$makan->jumlah}}</td>
                <td> {{$makan->sisa}}</td>
              <td>
                <a href="\makan\{{$makan->id}}/edit" class="btn btn-warning btn-sm">edit</a>
                <a href="\makan\{{$makan->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data Akan Dihapus Lanjutkan')">Hapus</a>
              </td>
            </tr>
            </thead>
            @endforeach
